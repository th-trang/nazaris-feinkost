...
export default function PromoBanner() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-[60] w-full border-b border-amber-200/40 bg-gradient-to-r from-amber-500 via-green-600 to-emerald-600 text-white shadow-lg shadow-emerald-900/10">
